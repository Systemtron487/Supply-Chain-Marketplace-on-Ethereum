...
export default ({
    ...
    console.log('rendering form', createShipmentModel)
    return <Modal
    isOpen={createShipmentModel}
    // onAfterOpen={afterOpenModal}
    onRequestClose={() => {setCreateShipmentModel(false)}}
    // style={customStyles}
                            ...
                            <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                                <h4 className="text-lg font-medium text-gray-800">
                                    ...
                                    <p className="text-[15px] text-gray-600">
                                        A small description on Sanskar Awasthi's Supply chain 
                                        on Ethereum
                                        </p>
